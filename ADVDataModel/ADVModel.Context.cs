...
namespace ADVDataModel
{
    ...
    public partial class ADV2017Entities : DbContext
    {
        public ADV2017Entities()
            : base("name=ADV2017Entities")
        {
        }
        ...
        public virtual IQueryable<ufnGetContactInformation_Result> ufnGetContactInformation(Nullable<int> personID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetContactInformation_Result>("[ADV2017Entities].[ufnGetContactInformation](@PersonID)", personIDParameter);
        }
